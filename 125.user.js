...
// @updateURL   https://openuserjs.org/src/scripts/LazyBastard/DinoRPG_Faster.user.js#
// @downloadURL https://openuserjs.org/src/scripts/LazyBastard/DinoRPG_Faster.user.js#
// ==/UserScript==
...
'<img src="http://en.dinorpg.com/img/icons/elem_2.gif" alt="Wood" /> Precious Spring</td>' +
...
'<td style="font-size:12px;font-weight:bold;font-variant: small-caps;color:#000000; background-color:#1399EB !important;">very high</td></tr></table></div>'
        ...
        case "http://en.dinorpg.com/img/icons/elem_3.gif": /* Lightning skills */
            ...
            node.innerHTML = '<div style="background-color:#FFBA00 !important; border-color:#FFFFFF; color:#FFFFFF;" nowrap><img src="http://en.dinorpg.com/img/icons/elem_3.gif" /> <strong>LIGHTNING</strong>' +
 '<div style="float:left; width:100%;"><table><tr>' +
...
'<td <td style="background-color:#1399EB !important;color:#FFFFFF;">&nbsp;E&nbsp;</td>E</td>' +
...
'<td style="font-size:12px;font-weight:bold;font-variant: small-caps;color:#000000; background-color:#A3D3F8 !important;">very high</td></tr></table></div>'
    ...
    if (isdungeon) {       
        switch (dungeontitle) {
            ...
            case 'swf_title_Cuzcous Ruins':
                ...
                mapshow11.addEventListener("click", function () { var x = document.getElementById("dungeonmap4"); ((x.style.display == 'block') ? x.style.display = 'none' : x.style.display = 'block'); }, false);
